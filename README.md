...
This project is a continuation of Project 2. In Project 2, I designed the database for a Student Task Tracker system using the tables Students, Categories, and Tasks.

In Project 3, I implemented the database as a full-stack Python web application.
